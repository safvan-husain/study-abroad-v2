...
pub struct TurnJob {
    ...
    pub profile_course_interests: String,
    pub profile_ambitions: String,
    pub profile_primary_area: String,
    pub profile_candidate_areas_json: String,
    pub profile_student_phrase: String,
    pub profile_constraints_text: String,
...
pub fn send_message(
    ...
    let profile = ctx
        ...
        .conversation_id()
        .find(&conversation_id)
        .expect("conversation profile not found");
    ctx.db.turn_job().insert(TurnJob {
        ...
        presented_family_ids_json: selection.presented_family_ids_json,
        selected_family_ids_json: selection.selected_family_ids_json,
        presented_offering_ids_json: selection.presented_offering_ids_json,
        provisional_offering_ids_json: selection.provisional_offering_ids_json,
        suppressed_offering_ids_json: selection.suppressed_offering_ids_json,
        confirmed_offering_ids_json: selection.confirmed_offering_ids_json,
        comparison_criterion: selection.comparison_criterion,
        profile_background: profile.background,
        profile_course_interests: profile.course_interests,
        profile_ambitions: profile.ambitions,
        profile_primary_area: profile.primary_area,
        profile_candidate_areas_json: profile.candidate_areas_json,
        profile_student_phrase: profile.student_phrase,
        profile_constraints_text: profile.constraints_text,
        run_id: None,
        error_code: None,
    });
    ...
    ["pending", "retrying", "claimed"]
        ...
        .filter_map(|job| {
            ...
            Some(WorkerPendingTurn {
                ...
                presented_family_ids_json: job.presented_family_ids_json,
                selected_family_ids_json: job.selected_family_ids_json,
                presented_offering_ids_json: job.presented_offering_ids_json,
                provisional_offering_ids_json: job.provisional_offering_ids_json,
                suppressed_offering_ids_json: job.suppressed_offering_ids_json,
                confirmed_offering_ids_json: job.confirmed_offering_ids_json,
                comparison_criterion: job.comparison_criterion,
                profile_background: job.profile_background,
                profile_course_interests: job.profile_course_interests,
                profile_ambitions: job.profile_ambitions,
                profile_primary_area: job.profile_primary_area,
                profile_candidate_areas_json: job.profile_candidate_areas_json,
                profile_student_phrase: job.profile_student_phrase,
                profile_constraints_text: job.profile_constraints_text,
...
mod tests {
    ...
    fn turn(
        ...
        TurnJob {
            ...
            profile_course_interests: String::new(),
            profile_ambitions: String::new(),
            profile_primary_area: String::new(),
            profile_candidate_areas_json: "[]".into(),
            profile_student_phrase: String::new(),
            profile_constraints_text: String::new(),
            run_id: None,
            error_code: None,
        }
    }
