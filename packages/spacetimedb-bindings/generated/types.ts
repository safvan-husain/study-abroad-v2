...
export const TurnJob = __t.object("TurnJob", {
  ...
  confirmedOfferingIdsJson: __t.string(),
  comparisonCriterion: __t.string(),
  profileBackground: __t.string(),
  profileCourseInterests: __t.string(),
  profileAmbitions: __t.string(),
  profilePrimaryArea: __t.string(),
  profileCandidateAreasJson: __t.string(),
  profileStudentPhrase: __t.string(),
  profileConstraintsText: __t.string(),
